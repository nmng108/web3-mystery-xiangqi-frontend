...
export type { MysteryXiangqiGoldToken } from './contracts/MysteryXiangqiGoldToken';
export { MysteryXiangqiGoldToken__factory } from './factories/contracts/MysteryXiangqiGoldToken__factory';
