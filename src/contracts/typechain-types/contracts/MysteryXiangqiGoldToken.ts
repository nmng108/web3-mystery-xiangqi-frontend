...
export interface MysteryXiangqiGoldTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DOMAIN_SEPARATOR'
      | 'allowance'
  ...
  getEvent(
    nameOrSignatureOrTopic: 'Approval' | 'EIP712DomainChanged' | 'OwnershipTransferred' | 'Transfer'
  ): EventFragment;
...
export interface MysteryXiangqiGoldToken extends BaseContract {
  connect(runner?: ContractRunner | null): MysteryXiangqiGoldToken;
  waitForDeployment(): Promise<this>;

  interface: MysteryXiangqiGoldTokenInterface;
