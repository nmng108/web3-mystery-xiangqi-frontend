...
type RegistrationMessage = undefined | {
  message: string,
  color: string,
}
...
const Login: React.FC = () => {
  ...
  useEffect(() => {
    setWaitForRegistrationMessage((selectedAccount && !isRegistrationModalOpen) ?
      !user ?
        { message: 'Just a minute! Waiting for your account to be registered...', color: 'text-zinc-800' }
        :
      ...
      <div
        ...
        <div className="text-center text-white p-8 rounded-lg backdrop-blur-md">
          ...
          <Dialog
            ...
            PaperProps={{ component: 'form', onSubmit: handleRegisterNewPlayer, } as Partial<PaperProps<React.ElementType>>}
          >
            {/* Dialog Header */}
